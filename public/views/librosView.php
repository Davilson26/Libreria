        ...
        <div class="card ">
            ...
            <div class="card-body">
                <form id="libroForm">
                    ...
                    <input class="form-control text-center my-1 px-1 mx-1" type="text" id="titulo" autofocus placeholder="Titulo" required>
                    <input class="form-control text-center my-1 px-1 mx-1" type="text" id="autor" placeholder="Autor" required>
                    
                    <label for="disponibilidad" class="text-info">Disponibilidad</label>
                    <select class="form-control text-center my-1 px-1 mx-1" name="disponibilidad" id="disponibilidad">
                        <option value="1">Si</option>
                        <option value="0">No</option>
                    </select>

                    <label for="disponibilidad" class="text-info">Tipo</label>
                    <select class="form-control text-center my-1 px-1 mx-1" name="categoria_id" id="categoria_id">
